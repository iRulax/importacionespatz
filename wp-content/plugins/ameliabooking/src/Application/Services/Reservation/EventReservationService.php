...
class EventReservationService extends AbstractReservationService
{
    ...
    public function book($eventData, $reservation, $save)
    {
        ...
        if (!empty($limitPerCustomerEvents) && $limitPerCustomerEvents['enabled'] && (!isset($eventData['isBackendOrCabinet']) || !$eventData['isBackendOrCabinet'])) {
            ...
            if ($count >= $limitPerCustomerEvents['numberOfApp']) {
                throw new EventBookingUnavailableException('');
            }
        }

    ...
    function Amelia_get_settings_fields()
    {
        ...
        $fields['Amelia_settings_section_customers'] = array(
            ...
            'Amelia_create_customers' => array(
                ...
                'callback'          => 'Amelia_settings_callback_create',
                'sanitize_callback' => 'absint',
                'args'              => array(),
            ),
...
if (! function_exists('Amelia_settings_callback_create')) {
    function Amelia_settings_callback_create()
    {
        ?>
        <form method="post">
...
if (! function_exists('Amelia_transform_users_enabled')) {
    function Amelia_transform_users_enabled($default = 0)
    {
        return (bool) apply_filters('Amelia_transform_users_enabled', (bool) get_option('Amelia_subscribers_to_customers', $default));
    }
}

if (! function_exists('Amelia_create_customers_enabled')) {
    function Amelia_create_customers_enabled($default = 0)
    {
        return (bool) apply_filters('Amelia_create_customers_enabled', (bool) get_option('Amelia_create_customers', $default));
    }
}

if (! function_exists('Amelia_create_providers_enabled')) {
    function Amelia_create_providers_enabled($default = 0)
    {
        return (bool) apply_filters('Amelia_create_providers_enabled', (bool) get_option('Amelia_create_providers', $default));
    }
}
...
add_action('bp_init', 'convertUserRoles');
...
//  add_action('bp_init', 'createCustomers');
